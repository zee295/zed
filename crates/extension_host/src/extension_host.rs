...
impl ExtensionStore {
    ...
    pub fn new(
        ...
        let (extension_index, extension_index_needs_rebuild) = {
            ...
            (extension_index, extension_index_needs_rebuild)
        };
        #[cfg(target_family = "wasm")]
        let (extension_index, extension_index_needs_rebuild) = (ExtensionIndex::default(), true);
