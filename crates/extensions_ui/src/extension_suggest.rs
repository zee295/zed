    ...
    cx.observe_new(|workspace: &mut Workspace, window, cx| {
        ...
        cx.subscribe(
            ...
            |workspace, extension_store, event, cx| {
                if let crate::store::Event::ExtensionsUpdated = event {
...
fn extension_auto_install_enabled(extension_id: &str, cx: &App) -> bool {
    #[cfg(not(target_family = "wasm"))]
    {
...
fn show_suggestion(
    ...
    if extension_store
        ...
        || extension_store
            ...
            .contains_key(extension_id)
        || extension_auto_install_enabled(extension_id, cx)
